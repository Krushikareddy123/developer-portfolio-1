...
const SocialIcons = () => {
    ...
    return (
        <div className="social-icons fixed bottom-10 left-10 z-50 flex flex-col gap-4 text-xl mix-blend-difference text-white max-md:hidden">
            ...
            <a href={config.contact.twitter} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accentColor)] transition-colors"><FaTwitter /></a>
            <a href={config.contact.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accentColor)] transition-colors"><FaInstagram /></a>
            <a href={config.contact.facebook} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accentColor)] transition-colors"><FaFacebook /></a>
